...
function ContentLayout(props) {
    ...
    return (React.createElement(core_1.Grid, { container: true, direction: "column", justify: "center" },
...
function TabPanel(props) {
    ...
    return (React.createElement(core_1.Typography, { component: "div", role: "tabpanel", hidden: value !== index, id: `full-width-tabpanel-${index}`, "aria-labelledby": `full-width-tab-${index}` },
        React.createElement(core_1.Box, { className: classes.swipeView }, children)));
}
function ScrollTop(props) {
    const { children, window } = props;
    const classes = useStyles();
    const trigger = core_1.useScrollTrigger({
    ...
    return (React.createElement(core_1.Zoom, { in: trigger },
